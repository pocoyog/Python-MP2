...
print('         Machine Problem 2 (Python):          ')
print('Input the corresponding needed values in terms of Integers')
print('')

x1 = float(input('Value of x1: '))
x2 = float(input('Value of x2: '))
x3 = float(input('Value of x3: '))
y1 = float(input('Value of y1: '))
y2 = float(input('Value of y2: '))
y3 = float(input('Value of y3: '))
